...
- (void)setView
{
    ...
    [_emojiButton setImage:[UIImage imageNamed:@"keyboard"] forState:UIControlStateNormal];
    [_emojiButton setImage:[UIImage imageNamed:@"face"] forState:UIControlStateSelected];
